describe('Contact', function () {
  ...
  describe('Routes', function () {
    ...
    it('should go to the contact state', function() {
      ...
      expect($state.current.name).toEqual('app.contacts')
    });
  });
  ...
  describe('ContactController', function () {
    ...
    it('should filter contacts', function() {
      console.log(controller.filteredContacts);
    ...
    it('should route on goToContact call', function () {
      ...
      expect($state.go).toHaveBeenCalledWith('app.contact', { id: event.contactId });
    });
  });
});